# Anneal engineering log — archived

> **Archived:** This file preserves the former mixed backlog, completed work, benchmark notes,
> and investigation history. Open work now lives in [`../../TODO.md`](../../TODO.md), and
> consolidated measurements live in [`../benchmarks/current.md`](../benchmarks/current.md).

> **Original header:** Detailed implementation backlog and engineering record, beyond what was
> in the original build-system design. The current
> [README feature matrix](../../README.md#current-implementation-status) remains authoritative;
> the material below is preserved as historical rationale and measurements. Its section
> references point at the archived original build-system design unless stated otherwise.
